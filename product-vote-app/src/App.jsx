...
function App() {
  const DEFAULT_PRODUCTS = [
    { id: 1, name: "产品1", votes: 2 },
    { id: 2, name: "产品2", votes: 0 },
    { id: 3, name: "产品3", votes: 0 },
    { id: 4, name: "产品4", votes: 0 },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-600 via-red-700 to-red-900 text-white font-sans overflow-hidden relative selection:bg-red-200 selection:text-red-900">
      {/* 顶部 Header */}
